...
DEV_CLI_UTILS=("eza" "ripgrep" "tree" "ffmpeg" "bat" "fzf" "ast-grep" "jq" "yq" "fd" "zoxide" "sd" "dust" "parallel" "procs" "mprocs" "ncdu" "lazydocker" "lazygit" "fabric-ai" "btop" "ekphos" "yazi" "pi-coding-agent" "git-crypt" "opencode" "zellij" "macmon" "todoist-cli" "whatsapp-cli" "glow" "herdr" "mlr" "inshellisense")
...
PRODUCTIVITY_APPS=("rectangle" "todoist-app" "dropbox" "macwhisper" "iina" "microsoft-onenote" "localsend" "mole" "antigravity" "bettercmdtab" "caskhub" "handy")
